...
const CLOSING_PATTERNS = [
  ...
  /\b(?:has been|was)\s+(?:corrected|rectified|addressed|implemented|fixed|reconciled|resolved)\b/i,
  /\b(?:correction|rectification)\s+(?:has been|was)?\s*(?:implemented|completed|made)\b/i,
  /\b(?:necessary|required)\s+correction\s+has been\s+implemented\b/i,
  /\bclosed\b/i,
  /\bcompleted\b/i,
