  ...
  SELECT
    ...
    GREATEST(0,
      ...
      - CASE WHEN (
               ...
               OR attention_text LIKE '%visa%'
               OR attention_text LIKE '%otp%'
               OR attention_text LIKE '%password%'
               OR attention_text LIKE '%login%'
               OR attention_text LIKE '%subscription%'
               OR attention_text LIKE '%invoice follow-up%'
